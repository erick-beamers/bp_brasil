...
%*-------------------------------------------------------------------------------
\title              {Perspectivas de Brasil}
\subtitle           {Uma breve discussão.}
\author             {Erick \and Thiago \and Marcela \and Alexandre}
%\email              {nome@site.com}
...
%-
%*----------- SECTIONS ----------------------------------------------------------
\input{Sections/01-erick}
%\input{Sections/01-introduction}
\input{Sections/02-alexandre}
